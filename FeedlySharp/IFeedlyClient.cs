...
namespace FeedlySharp
{
  public interface IFeedlyClient
  {
    ...
    Task<bool> AddOrUpdateSubscription(string id, List<FeedlyCategory> categories = null, string optionalTitle = null, CancellationToken cancellationToken = default(CancellationToken));
    ...
    Task<List<FeedlySearchFeed>> FindFeeds(string searchQuery, int? count = null, string locale = null, CancellationToken cancellationToken = default(CancellationToken));
    string GetAuthenticationUri(string scope = "subscriptions", string state = default(String));
    Task<List<FeedlyCategory>> GetCategories(CancellationToken cancellationToken = default(CancellationToken));
    Task<List<FeedlyEntry>> GetEntries(string[] ids, CancellationToken cancellationToken = default(CancellationToken));
    ...
    Task<List<FeedlyFeed>> GetFeeds(string[] ids, CancellationToken cancellationToken = default(CancellationToken));
    ...
    Task<List<FeedlyCategoryUnreadCount>> GetMarkersUnreadCount(bool isAutoRefresh = false, DateTime? newerThan = null, string categoryId = null, CancellationToken cancellationToken = default(CancellationToken));
    Task<List<FeedlyEntry>> GetMixes(string contentId, int? count = null, bool unreadOnly = false, int? limitHours = null, DateTime? newerThan = null, bool backfill = true, CancellationToken cancellationToken = default(CancellationToken));
    ...
    Task<List<FeedlyTopic>> GetTopics(CancellationToken cancellationToken = default(CancellationToken));
    ...
    Task<Dictionary<string, string>> UpdatePreferences(Dictionary<string, string> preferences, CancellationToken cancellationToken = default(CancellationToken));
    Task<FeedlyUser> UpdateProfile(Dictionary<string, string> parameters, CancellationToken cancellationToken = default(CancellationToken));
